...
<html lang="en">
    ...
    <body>
    	...
    	<div class="container-fluid p-4" style="min-height: 92vh">
			...
			<div class="alert alert-danger h6 text-center">Supplier details has not deleted !...</div>
			<?php } ?>
    			...
    			<table class="table table-bordered text-center">
    				...
    				<tbody>
    					...
    					<tr>
    						...
    						<td>
    							<button class="btn btn-link text-decoration-none" onclick='location.href="edit_supplier.php?id=<?php echo $row['id']; ?>";'>Edit <i class="fas fa-edit"></i></button> |
    							<button class="btn btn-link text-decoration-none" onclick='if(confirm("Do you want to delete <?php echo $row['name']; ?>?")){ location.href="delete_supplier.php?id=<?php echo $row['id']; ?>";}'>Delete <i class="fas fa-trash-alt"></i></button>
    						</td>
    					</tr>
    					<?php } ?>
